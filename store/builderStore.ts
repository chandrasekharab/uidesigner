...
interface BuilderStore {
  ...
  // App mode
  appMode: 'builder' | 'transform' | 'renderer' | 'design' | 'schema-design' | 'region-map' | 'template-map';
  setAppMode: (mode: 'builder' | 'transform' | 'renderer' | 'design' | 'schema-design' | 'region-map' | 'template-map') => void;
...
export const useBuilderStore = create<BuilderStore>()(
  ...
  immer((set, get) => ({
    ...
    // ── App mode ───────────────────────────────────────────────────────────
    appMode: 'builder' as 'builder' | 'transform' | 'renderer' | 'design' | 'schema-design' | 'region-map' | 'template-map',
    setAppMode: (mode) =>
      set((s) => {
        s.appMode = mode;
      }),

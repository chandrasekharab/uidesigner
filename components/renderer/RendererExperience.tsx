    ...
    <div className="flex flex-col h-full overflow-hidden bg-slate-50">
      ...
      <div className="flex items-center gap-3 px-4 py-2 bg-white border-b border-slate-200 flex-shrink-0 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-slate-800">A2UI Renderer</span>
          <span className="text-[10px] font-mono text-slate-400">{sdkInfo.version}</span>
          {sdkInfo.mock && (
        ...
        <div className="relative">
          ...
          {showRendererMenu && (
            <div className="absolute top-full left-0 mt-1 z-20 bg-white border border-slate-200 rounded-lg shadow-lg py-1 w-52">
              {renderers.map((r) => (
                <button
                  key={r.id}
                  onClick={() => {
